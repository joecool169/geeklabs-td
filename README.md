...
Graphics are intentionally minimal at this stage so development effort can focus on:
- Balance
- Pacing
...
- Static build suitable for easy sharing and hosting

## Tech Stack

- Phaser 3
- Vite
- JavaScript (minimal framework overhead)
...
A temporary demo may be hosted during development for sharing and feedback.
