...
class GameDomView {
  constructor(root = document) {
    ...
    this.refs = {
      ...
      hudWavePreviewEl: root.getElementById("hud-wave-preview"),
      selectedTowerSpecialtyEl: root.getElementById("tower-specialty"),
      touchTowerSpecialtyEl: root.getElementById("touch-tower-specialty"),
